    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                                    <select class="form-control" id="settings" onchange="changesetting()">
                                    <option value="auto">Auto</option><option value="manual" selected="">Manual</option></select>
                            </div>
                    </div>
                <hr>
                <div id="showinputmasuk"><div class="row"><div class="col-md-3"> IP Timbangan Masuk</div><div class="col-md-1">:</div><div class="col-md-4"><input type="text" value="192.168.1.8" id="ipmasuk" class="form-control"></div><div class="col-md-2"><input type="text" value="20000" id="portmasuk" class="form-control"></div></div><div class="row" style="padding-top:15px;"><div class="col-md-3"> IP Timbangan Keluar</div><div class="col-md-1">:</div><div class="col-md-4"><input type="text" id="ipkeluar" value="192.168.1.27" class="form-control"></div><div class="col-md-2"><input type="text" id="portkeluar" value="20000" class="form-control"></div></div></div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary">Save IP Settings</button>
            </div>
        </div>
    </div>
</div> --}}