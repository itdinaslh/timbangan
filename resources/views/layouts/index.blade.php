        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
				{{-- <img src="/images/logo/LogoDLH.png" alt="" class="brand-title" width="124px" height="33px"> --}}
                <img src="/images/logo/dlh.png" alt="" class="logo-abbr" width="75" viewBox="0 0 53 53">
                <p class="brand-title">dlh</p>
        ...
        ***********************************-->
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <h2 class="text-center mb-5">Monitoring TPST Bantargebang </h2>
            </div>
        </div>
        <!--**********************************
            Sidebar end
        ...
        <div class="content-body">
            <div class="container-fluid">
				{{-- <div class="row page-titles">
					<ol class="breadcrumb">
						<li class="breadcrumb-item active"><a href="javascript:void(0)">@yield('MainMenu')</a></li>
